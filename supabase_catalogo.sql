...
-- ── ACTUALIZAR RLS: asegurar DELETE e INSERT para usuarios autenticados ──
-- Ejecutar si el guardado desde la app no funciona
...
-- Una policy por operación (más explícito y seguro)
